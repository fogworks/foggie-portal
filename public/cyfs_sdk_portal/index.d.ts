...
export class NFTAgreeApplyTx implements RawEncode {
    nft_id: ObjectId;
    user_id: ObjectId;
    constructor(nft_id: ObjectId, user_id: ObjectId);
    raw_measure(ctx?: any): BuckyResult<number>;
    raw_encode(buf: Uint8Array, ctx?: any): BuckyResult<Uint8Array>;
}
...
export class NFTApplyBuyTx implements RawEncode {
    ...
    price: JSBI;
    coin_id: CoinTokenId;
    constructor(nft_id: ObjectId, price: JSBI, coin_id: CoinTokenId);
    raw_measure(ctx?: any): BuckyResult<number>;
    raw_encode(buf: Uint8Array, ctx?: any): BuckyResult<Uint8Array>;
}
...
export class NFTAuctionTx implements RawEncode {
    ...
    price: JSBI;
    coin_id: CoinTokenId;
    duration_block_num: JSBI;
    constructor(nft_id: ObjectId, price: JSBI, coin_id: CoinTokenId, duration_block_num: JSBI);
    raw_measure(ctx?: any): BuckyResult<number>;
    raw_encode(buf: Uint8Array, ctx?: any): BuckyResult<Uint8Array>;
}
...
/*****************************************************
  ...
  * author: weiqiushi@buckyos.com
  *****************************************************/
export class NFTBidTx implements RawEncode {
    nft_id: ObjectId;
    price: JSBI;
    coin_id: CoinTokenId;
    constructor(nft_id: ObjectId, price: JSBI, coin_id: CoinTokenId);
...
export class NFTBidTxDecoder implements RawDecode<NFTBidTx> {
    raw_decode(buf: Uint8Array, ctx?: any): BuckyResult<[NFTBidTx, Uint8Array]>;
}
...
/*****************************************************
  ...
  * author: weiqiushi@buckyos.com
  *****************************************************/
export class NFTBuyTx implements RawEncode {
    nft_id: ObjectId;
    price: JSBI;
    coin_id: CoinTokenId;
    constructor(nft_id: ObjectId, price: JSBI, coin_id: CoinTokenId);
...
export class NFTBuyTxDecoder implements RawDecode<NFTBuyTx> {
    raw_decode(buf: Uint8Array, ctx?: any): BuckyResult<[NFTBuyTx, Uint8Array]>;
}
...
/*****************************************************
  ...
  * author: weiqiushi@buckyos.com
  *****************************************************/
export class NFTCancelApplyBuyTx implements RawEncode {
    nft_id: ObjectId;
    constructor(nft_id: ObjectId);
    raw_measure(ctx?: any): BuckyResult<number>;
    raw_encode(buf: Uint8Array, ctx?: any): BuckyResult<Uint8Array>;
}
export class NFTCancelApplyBuyTxDecoder implements RawDecode<NFTCancelApplyBuyTx> {
    raw_decode(buf: Uint8Array, ctx?: any): BuckyResult<[NFTCancelApplyBuyTx, Uint8Array]>;
}
...
export class NFTCreateTx implements RawEncode {
    ...
    name: string;
    state: NFTState;
    constructor(desc: NFTDesc, name: string, state: NFTState);
    raw_measure(ctx?: any): BuckyResult<number>;
    raw_encode(buf: Uint8Array, ctx?: any): BuckyResult<Uint8Array>;
}
...
/*****************************************************
  ...
  * author: weiqiushi@buckyos.com
  *****************************************************/
export class NFTSellTx implements RawEncode {
    nft_id: ObjectId;
    price: JSBI;
    coin_id: CoinTokenId;
    duration_block_num: JSBI;
...
export class NFTSellTxDecoder implements RawDecode<NFTSellTx> {
    raw_decode(buf: Uint8Array, ctx?: any): BuckyResult<[NFTSellTx, Uint8Array]>;
}
...
export class NFTSellTx2 implements RawEncode {
    ...
    price: JSBI;
    coin_id: CoinTokenId;
    sub_sell_infos: [CoinTokenId, JSBI][];
    constructor(nft_id: ObjectId, price: JSBI, coin_id: CoinTokenId, sub_sell_infos: [CoinTokenId, JSBI][]);
    raw_measure(ctx?: any): BuckyResult<number>;
    raw_encode(buf: Uint8Array, ctx?: any): BuckyResult<Uint8Array>;
}
...
export class NFTCreateTx2 implements RawEncode {
    ...
    sub_names: string[];
    sub_states: NFTState[];
    constructor(desc: NFTDesc, name: string, state: NFTState, sub_names: string[], sub_states: NFTState[]);
    raw_measure(ctx?: any): BuckyResult<number>;
    raw_encode(buf: Uint8Array, ctx?: any): BuckyResult<Uint8Array>;
}
...
export class DecAppBodyContent extends ProtobufBodyContent {
    ...
    constructor(source: BuckyHashMap<BuckyString, ObjectId>, icon: string | undefined, desc: string | undefined, source_desc: BuckyHashMap<BuckyString, BuckyString>, tags: BuckyHashMap<BuckyString, BuckyString>);
...
export const ANONYMOUS_DEC_APP: DecAppId;
...
export class MetaClient {
    ...
    create_tx(caller: TxCaller, body: MetaTxBody, gas_price: number, max_fee: number, tx_data: Uint8Array): Promise<BuckyResult<Tx>>;
    create_multi_body_tx(caller: TxCaller, bodys: MetaTxBody[], gas_price: number, max_fee: number, tx_data: Uint8Array): Promise<BuckyResult<Tx>>;
    ...
    bid_name(caller: StandardObject, owner: Option<ObjectId>, name: string, price: JSBI, rent: number, secret: PrivateKey): Promise<BuckyResult<TxId>>;
    update_name(caller: StandardObject, name: string, info: NameInfo, write_flag: number, secret: PrivateKey): Promise<BuckyResult<TxId>>;
...
export class GlobalStateStub {
    constructor(requestor: GlobalStateRequestor, target?: ObjectId | undefined, target_dec_id?: ObjectId | undefined);
    ...
    create_path_op_env_with_access(access?: RootStateOpEnvAccess): Promise<BuckyResult<PathOpEnvStub>>;
    create_single_op_env(): Promise<BuckyResult<SingleOpEnvStub>>;
    create_single_op_env_with_access(access?: RootStateOpEnvAccess): Promise<BuckyResult<SingleOpEnvStub>>;
}
export class SingleOpEnvStub {
    constructor(requestor: OpEnvRequestor, target?: ObjectId, target_dec_id?: ObjectId);
...
export class GlobalStateAccessStub {
    constructor(requestor: GlobalStateAccessRequestor, target?: ObjectId | undefined, target_dec_id?: ObjectId | undefined);
...
export class NONRequestor {
    ...
    update_object_meta(req: NONUpdateObjectMetaOutputRequest): Promise<BuckyResult<NONPutObjectOutputResponse>>;
}
...
export class SharedCyfsStack {
    ...
    wait_online(timeoutInMicroSeconds?: JSBI): Promise<BuckyResult<null>>;
...
class RouterHandlerItem {
    ...
    id: string;
    dec_id: ObjectId | undefined;
    constructor(chain: RouterHandlerChain, category: RouterHandlerCategory, index: number, id: string, dec_id: ObjectId | undefined, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: RouterHandlerAnyRoutine | undefined);
    set_routine(routine?: RouterHandlerAnyRoutine): void;
...
export class RouterHandlerUnregisterItem {
    id: string;
    dec_id?: ObjectId | undefined;
    constructor(chain: RouterHandlerChain, category: RouterHandlerCategory, id: string, dec_id?: ObjectId | undefined);
...
export class RouterWSHandlerHandlerManagerImpl {
    ...
    static remove_handler(manager: RouterWSHandlerHandlerManagerImpl, chain: RouterHandlerChain, category: RouterHandlerCategory, id: string, dec_id?: ObjectId): Promise<BuckyResult<boolean>>;
...
export class RouterHandlerWSHandlerManager {
    ...
    add_handler<REQ, RESP>(chain: RouterHandlerChain, id: string, index: number, category: RouterHandlerCategory, req_codec: JsonCodec<REQ>, resp_codec: JsonCodec<RESP>, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: EventListenerAsyncRoutineT<RouterHandlerRequest<REQ, RESP>, RouterHandlerResponse<REQ, RESP>>): Promise<BuckyResult<void>>;
...
export class RouterHandlerManager {
    ...
    add_put_object_handler(chain: RouterHandlerChain, id: string, index: number, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: RouterHandlerPutObjectRoutine): Promise<BuckyResult<void>>;
    add_get_object_handler(chain: RouterHandlerChain, id: string, index: number, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: RouterHandlerGetObjectRoutine): Promise<BuckyResult<void>>;
    ...
    add_delete_object_handler(chain: RouterHandlerChain, id: string, index: number, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: RouterHandlerDeleteObjectRoutine): Promise<BuckyResult<void>>;
    add_put_data_handler(chain: RouterHandlerChain, id: string, index: number, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: RouterHandlerPutDataRoutine): Promise<BuckyResult<void>>;
    add_get_data_handler(chain: RouterHandlerChain, id: string, index: number, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: RouterHandlerGetDataRoutine): Promise<BuckyResult<void>>;
    add_delete_data_handler(chain: RouterHandlerChain, id: string, index: number, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: RouterHandlerDeleteDataRoutine): Promise<BuckyResult<void>>;
    add_sign_object_handler(chain: RouterHandlerChain, id: string, index: number, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: RouterHandlerSignObjectRoutine): Promise<BuckyResult<void>>;
    add_verify_object_handler(chain: RouterHandlerChain, id: string, index: number, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: RouterHandlerVerifyObjectRoutine): Promise<BuckyResult<void>>;
    add_encrypt_data_handler(chain: RouterHandlerChain, id: string, index: number, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: RouterHandlerEncryptDataRoutine): Promise<BuckyResult<void>>;
    add_decrypt_data_handler(chain: RouterHandlerChain, id: string, index: number, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: RouterHandlerDecryptDataRoutine): Promise<BuckyResult<void>>;
    add_acl_handler(chain: RouterHandlerChain, id: string, index: number, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: RouterHandlerAclRoutine): Promise<BuckyResult<void>>;
    add_handler<REQ, RESP>(chain: RouterHandlerChain, id: string, index: number, category: RouterHandlerCategory, req_codec: JsonCodec<REQ>, resp_codec: JsonCodec<RESP>, filter: string | undefined, req_path: string | undefined, default_action: RouterHandlerAction, routine?: EventListenerAsyncRoutineT<RouterHandlerRequest<REQ, RESP>, RouterHandlerResponse<REQ, RESP>>): Promise<BuckyResult<void>>;
    remove_handler(chain: RouterHandlerChain, category: RouterHandlerCategory, id: string): Promise<BuckyResult<boolean>>;
}
...
export type RouterHandlerEncryptDataRequest = RouterHandlerRequest<CryptoEncryptDataInputRequest, CryptoEncryptDataInputResponse>;
export type RouterHandlerDecryptDataRequest = RouterHandlerRequest<CryptoDecryptDataInputRequest, CryptoDecryptDataInputResponse>;
...
export type RouterHandlerEncryptDataResult = RouterHandlerResponse<CryptoEncryptDataInputRequest, CryptoEncryptDataInputResponse>;
export type RouterHandlerDecryptDataResult = RouterHandlerResponse<CryptoDecryptDataInputRequest, CryptoDecryptDataInputResponse>;
...
export class CryptoRequestor {
    ...
    decode_encrypt_data_response(resp: Response): Promise<BuckyResult<CryptoEncryptDataOutputResponse>>;
    encrypt_data(req: CryptoEncryptDataOutputRequest): Promise<BuckyResult<CryptoEncryptDataOutputResponse>>;
    encode_decrypt_data_request(req: CryptoDecryptDataOutputRequest): HttpRequest;
    decode_decrypt_data_response(resp: Response): Promise<BuckyResult<CryptoDecryptDataOutputResponse>>;
    decrypt_data(req: CryptoDecryptDataOutputRequest): Promise<BuckyResult<CryptoDecryptDataOutputResponse>>;
}
...
export const CRYPTO_REQUEST_FLAG_CRYPT_BY_OWNER: number;
export const CRYPTO_REQUEST_FLAG_CRYPT_BY_DEVICE: number;
...
export class GlobalStatePathAccessItem {
    ...
    static new(path: string, access: AccessString): GlobalStatePathAccessItem;
    static new_group(path: string, zone: ObjectId | undefined, zone_category: DeviceZoneCategory | undefined, dec: ObjectId | undefined, access: AccessPermissions): GlobalStatePathAccessItem;
    to_obj(): any;
    static from_obj(obj: any): GlobalStatePathAccessItem;
}
...
export class GlobalStateMetaRequestor {
    category: GlobalStateCategory;
    service_url: string;
    constructor(category: GlobalStateCategory, requestor: BaseRequestor, dec_id?: ObjectId | undefined);
    ...
    encode_common_headers(action: MetaAction, com_req: MetaOutputRequestCommon, http_req: HttpRequest): void;
    encode_add_access_request(req: GlobalStateMetaAddAccessOutputRequest): HttpRequest;
    add_access(req: GlobalStateMetaAddAccessOutputRequest): Promise<BuckyResult<GlobalStateMetaAddAccessOutputResponse>>;
    encode_remove_access_request(req: GlobalStateMetaRemoveAccessOutputRequest): HttpRequest;
    remove_access(req: GlobalStateMetaRemoveAccessOutputRequest): Promise<BuckyResult<GlobalStateMetaRemoveAccessOutputResponse>>;
    encode_clear_access_request(req: GlobalStateMetaClearAccessOutputRequest): HttpRequest;
    clear_access(req: GlobalStateMetaClearAccessOutputRequest): Promise<BuckyResult<GlobalStateMetaClearAccessOutputResponse>>;
    encode_add_link_request(req: GlobalStateMetaAddLinkOutputRequest): HttpRequest;
    add_link(req: GlobalStateMetaAddLinkOutputRequest): Promise<BuckyResult<GlobalStateMetaAddLinkOutputResponse>>;
    encode_remove_link_request(req: GlobalStateMetaRemoveLinkOutputRequest): HttpRequest;
    remove_link(req: GlobalStateMetaRemoveLinkOutputRequest): Promise<BuckyResult<GlobalStateMetaRemoveLinkOutputResponse>>;
    encode_clear_link_request(req: GlobalStateMetaClearLinkOutputRequest): HttpRequest;
    clear_link(req: GlobalStateMetaClearLinkOutputRequest): Promise<BuckyResult<GlobalStateMetaClearLinkOutputResponse>>;
}

export class GlobalStateMetaStub {
    constructor(requestor: GlobalStateMetaRequestor, target?: ObjectId | undefined, dec_id?: ObjectId | undefined);
    add_access(item: GlobalStatePathAccessItem): Promise<BuckyResult<boolean>>;
    remove_access(item: GlobalStatePathAccessItem): Promise<BuckyResult<GlobalStatePathAccessItem | undefined>>;
    clear_access(): Promise<BuckyResult<number>>;
    add_link(source: string, target: string): Promise<BuckyResult<boolean>>;
    remove_link(source: string): Promise<BuckyResult<GlobalStatePathLinkItem | undefined>>;
    clear_link(): Promise<BuckyResult<number>>;
}
...
export class CyfsChainBipPath {
    ...
    constructor(purpose: number, coin: CyfsChainObjectType, type_code: ObjectTypeCode, account: number, network: CyfsChainNetwork, address_index: number);
    static new_people(network?: CyfsChainNetwork, address_index?: number): CyfsChainBipPath;
    static new_device(account: number, network?: CyfsChainNetwork, address_index?: number): CyfsChainBipPath;
    to_string(): string;
}
...
export function to_file(path: fs.PathLike, obj: RawEncode): void;
...
export const ACCESS_GROUP_MASK: number;
...
export class RSAPrivateKey extends PrivateKey {
    code: number;
    value: pki.rsa.PrivateKey;
    constructor(code: number, value: pki.rsa.PrivateKey);
    raw_measure(ctx?: any, purpose?: RawEncodePurpose): BuckyResult<number>;
    raw_encode(buf: Uint8Array, ctx?: any, purpose?: RawEncodePurpose): BuckyResult<Uint8Array>;
    public(): PublicKey;
...
export class RSAPublicKey extends PublicKeyBase implements PublicKeyMatcher {
        constructor(code: number, public_key: pki.rsa.PublicKey);
...
export const OBJECT_FLAG_CTYPTO = 1;
...
export const OBJECT_PUBLIC_KEY_NONE = 0;
export const OBJECT_PUBLIC_KEY_SINGLE = 1;
export const OBJECT_PUBLIC_KEY_MN = 2;
export const OBJECT_BODY_FLAG_PREV = 1;
...
export class NFTSetNameTx implements RawEncode {
    nft_id: ObjectId;
    name: string;
    constructor(nft_id: ObjectId, name: string);
    raw_measure(ctx?: any): BuckyResult<number>;
    raw_encode(buf: Uint8Array, ctx?: any): BuckyResult<Uint8Array>;
}
...
export class NFTTransTx implements RawEncode {
    nft_id: ObjectId;
    to: ObjectId;
    nft_cached: Option<ObjectId>;
    constructor(nft_id: ObjectId, to: ObjectId, nft_cached: Option<ObjectId>);
    raw_measure(ctx?: any): BuckyResult<number>;
    raw_encode(buf: Uint8Array, ctx?: any): BuckyResult<Uint8Array>;
}
...
export class SetBenefiTx implements RawEncode {
    address: ObjectId;
    to: ObjectId;
    constructor(address: ObjectId, to: ObjectId);
    raw_measure(ctx?: any): BuckyResult<number>;
    raw_encode(buf: Uint8Array, ctx?: any): BuckyResult<Uint8Array>;
}
