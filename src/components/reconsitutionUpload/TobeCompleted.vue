  ...
  <div class="uploader-file">
    <div>
      <div class="uploader-file-info">
        <div class="uploader-file-name" :title="curFile.fileName">
        ...
        <div class="uploader-file-prefix">
          <el-tooltip placement="top">
            <template #content>
              <div>{{ curFile.urlPrefix }}</div>
            </template>
            <a href="javascript:;" @click="toPath">{{ curFile.urlPrefix }} </a>
          </el-tooltip>
        </div>
...
let fileIcon = computed(() => {
  let fileName = curFile.value.fileName.toLowerCase();
  if (
