...
|email|string|否|foggie邮箱地址，用于获取私钥|
|billId|string|否|挂单的id|
|transactionId|string|否|买单的transactionId|

入参示例：
``` json
{"email":"tianbao.liu@megaops.net","billId":"11", "transactionId":"3a22ff00b5e135a04c36d7759496c9d2e8ebf3487f775ce93bf0b49778a55977"}
```
返回数据：
        ...
        "data": [
            {
                ...
                "bill_id": "79",
                "pst": "1",
                "peer_id": "12D3KooWEJTLsHbP6Q1ybC1u49jFi77tQ8hYtraqGtKTHCXFzLnA",
                "rpc": "218.2.96.99:6007",
                "used_space": 13347423,
                "total_space": 1073741824,
                "expire": 1698745598000,
                "foggie_id": "baeqagnru",
                "total_price": "25.0000",
                "transaction_id": "182d62e9c0f51abcc1983d4773476aa475c2ba58ad9fdf19d1c0c6a4a3ff087d",
                "update_time": "2023-05-09 18:02:38",
                "create_time": "2023-05-09 18:01:32",
                "_id": "1ZS1ExYf4oV5pNlV"
            },
            {
                "email": "tianbao.liu@megaops.net",
                "order_id": "79",
                ...
                "used_space": 13455967,
                "total_space": 1073741824,
                "expire": 1698755685000,
                "foggie_id": "baeqagnzz",
                "total_price": "25.0000",
                "transaction_id": "5093a92ec8d16b42374cd4c9bc8a16ba720e2730dfdd2fff498b8092f50148c1",
                "update_time": "2023-05-10 15:12:07",
                "create_time": "2023-05-10 14:27:56",
                "_id": "1k3ukPNuDUc1OTQJ"
            },
            {
                "email": "tianbao.liu@megaops.net",
                "order_id": "121",
                ...
                "used_space": 1766491,
                "total_space": 1073741824,
                "expire": "2023-11-02T11:53:19.000Z",
                "foggie_id": "baeqagmjsge",
                "total_price": "25.0000",
                "transaction_id": "7eb9af9690c0eeac42c3c17e30cee2c6544ad5ea9ed6048230f22d9f62cc0d87",
                "block_num": 5241644,
                "update_time": "2023-05-11 20:06:21",
                "create_time": "2023-05-11 20:05:00",
                "_id": "2ebRnJrZD6lA5O6p"
            },
            {
                "email": "tianbao.liu@megaops.net",
                "order_id": "49",
                ...
                "foggie_id": "",
                "total_price": "25.0000",
                "transaction_id": "2f004563a3d4049a8adc19f70d4f35038282c3998dda16ababdfb80e56ab4c13",
                "update_time": "2023-05-06 16:19:35",
                "create_time": "2023-05-06 16:19:35",
                "_id": "3V3UOUsz11wovn37"
            },
            {
                "email": "tianbao.liu@megaops.net",
                "order_id": "52",
                ...
                "foggie_id": "",
                "total_price": "25.0000",
                "transaction_id": "028e509de893798b458192a4c572a90ea09a52f6cd57c04f5696f90acf8de891",
                "update_time": "2023-05-06 16:21:10",
                "create_time": "2023-05-06 16:21:10",
                "_id": "5AcHKolL97tf4OEu"
            }
        ],
        "time": 1684138723242
    },
        ...
        "data": [
            {
                ...
                "created_time": "2023-05-12T01:30:51.000Z",
                "epoch": 24,
                "user_pledge_amount": "92.0000",
                "miner_lock_pst_amount": "1",
                "miner_lock_dmc_amount": "62.5000",
                "price_amount": "1.0000",
                "settlement_pledge_amount": "0.5000",
                "lock_pledge_amount": "1.5000",
                "state": 1,
                "deliver_start_date": "2023-05-12T01:35:27.000Z",
                "latest_settlement_date": "2023-05-12T01:45:27.000Z",
                "miner_lock_rsi_amount": "31.7500",
                "miner_rsi_amount": "31.7500",
                "user_rsi_amount": "1.0000",
                "deposit_amount": "1.0000",
                "deposit_valid": "2023-05-12T05:35:27.000Z",
                "cancel_date": "1970-01-01T00:00:00.000Z",
                "createdAt": "2023-05-12T01:30:54.000Z",
                "used_space": 13455967,
                "total_space": 1073741824,
                "foggie_id": "baeqagmjshe",
                "file_count": 2,
                "challenge_period": 18962989
            }
        ],
        "time": 1683875314314
    },
...
# 用户发起超时赔付
http://127.0.0.1:3000/order/pay_challenge<br>
接口类型：HTTP<br>
POST，content-type:json<br>
入参：
|参数名|数据类型|是否可为空|备注|
...
入参示例：
``` json
{"orderId":"121","email":"tianbao.liu@megaops.net","chainId":"bb6e31180359e169335481bad672aadf57cfb5787379bedb6a5dce916fcb0ac5"}
```
...
``` json
{
    ...
    "data": {
        "code": 200,
        "msg": "success",
        "data": "7df33095787e60e213a56e402887ffa3da33bc40f30a3042dbb9390a77774e2d",
        "time": 1683810257488
    },
    "time": 1683810257488
}
...
# 预提交merkle树
http://127.0.0.1:3000/order/pre_push_merkle<br>
接口类型：HTTP<br>
POST，content-type:json<br>
入参：
|参数名|数据类型|是否可为空|备注|
...
入参示例：
``` json
{"email":"tianbao.liu@megaops.net","orderId":"333"}
```
...
# 完成merkle树
http://127.0.0.1:3000/order/complete_push_merkle<br>
接口类型：HTTP<br>
POST，content-type:json<br>
入参：
|参数名|数据类型|是否可为空|备注|
...
# 获取提交merkle树列表
http://127.0.0.1:3000/order/merkle_list<br>
接口类型：HTTP<br>
POST，content-type:json<br>
...
入参示例：
``` json
{"email":"tianbao.liu@megaops.net","orderId":"129","pageSize":4,"pageNo":1}
```
            ...
            "list": [
                {
                    "order_id": "129",
                    "email": "tianbao.liu@megaops.net",
                    "merkle_root": "f670d61436650642ff169413b9ded3b75ad66450eeffa286df113e879e20a760",
                    "block_num": "4096",
                    "transaction_id": "17740fa0249ffbbe43e4b19b3f7f881db43054edb512f700c30cb17fc9237902",
                    "chain_block_num": 5338462,
                    "update_time": "2023-05-12 09:31:48",
                    "create_time": "2023-05-12 09:31:48",
                    "_id": "HUZdbDu1TPaPgOee"
                }
            ],
            "count": 1
        },
...
# 发起挑战
http://127.0.0.1:3000/order/req_challenge<br>
接口类型：HTTP<br>
POST，content-type:json<br>
...
入参示例：
``` json
{"email":"tianbao.liu@megaops.net","orderId":"129","limit":2,"pageNum":1}
```
...
|email|string|否|foggie邮箱地址|
|deviceType|int|否|设备类型，1 foggie 2 foggie max 3 client|

入参示例：
``` json
{"email":"tianbao.liu@megaops.net","deviceId":"JqbOabbzZoYH2o1tPj1uDjzGOL85jAtOhHLOWgd5H490", "deviceType":1}
```
返回数据示例：
``` json
{
...
``` json
{
    ...
    "data": {
        ...
        "msg": "success",
        "data": {
            "encryptedPassword": "7769975a5048bd8e02c1a3f20edddd9a4f7141298c4cee9a69a6d7f12d6391a0"
        },
        "time": 1684142866898
    },
    "time": 1684142866898
...
入参示例
``` json
{"password":"123456789","email":"tianbao.liu@megaops.net"}
```
...
``` json
{
    ...
    "data": {
        "code": 200,
        "msg": "success",
        "data": "b68e89dcea9a03deb29e301cfb9ff7903931b4c4d3a0454f4dbba0d246c524a1",
        "time": 1684143241124
    },
    "time": 1684143241124
}
...
``` json
{
    ...
    "data": {
        "code": 200,
        "msg": "success",
        "data": "7769975a5048bd8e02c1a3f20edddd9a4f7141298c4cee9a69a6d7f12d6391a0",
        "time": 1684142807173
    },
    "time": 1684142807173
}
...
入参示例：
``` json
{"email":"tianbao.liu@megaops.net","privateKey":"5HsrwqjEJHsvqKgh4LDKwWQsfKK9UZygPYCspRaVfwM3recZCMn"}
```
...
# 根据私钥获取钱包地址
http://127.0.0.1:3000/user/get_username<br>
接口类型：HTTP<br>
POST，content-type:json<br>
入参：
|字段名|字段类型|是否可以为空|备注|
...
入参示例：
``` json
{"privateKey":"5HsrwqjEJHsvqKgh4LDKwWQsfKK9UZygPYCspRaVfwM3recZCMn"}
```
...
# 校验账户是否存在
http://127.0.0.1:3000/user/check_account<br>
接口类型：HTTP<br>
POST，content-type:json<br>
入参：
|参数名|数据类型|是否可为空|备注|
|:---|:---|:---|:---|
|username|string|否|用户的钱包地址|

入参示例：
``` json
{"username":"xuxindmc1234"}
```
...
|md5|string|否|文件内容的md5|
|deviceType|string|否|设备类型，1 foggie 2 foggie max 3 client|
...
# 外部保存文件密码本以及文件信息
http://127.0.0.1:3000/file/save_codebook<br>
接口类型：HTTP<br>
POST，content-type:json<br>
入参：
|参数名|数据类型|是否可为空|备注|
...
|fileSize|string|否|文件大小，单位Bytes|
|md5|string|否|文件内容的md5|
|cid|string|否|文件内容的cid|
|partArr|[]|否|文件的分片数组，包含partId 分片id 从0开始，base64data 文件的分片数据的base64，hashVaule 文件的分片数据的hash|
|deviceType|string|否|设备类型，1 foggie 2 foggie max 3 client|

入参说明：
base64data的值，先通过zip压缩原始数据，再将压缩后的数据转成base64，生成代码如下：
```javascript
var compressedData = zlib.gzipSync(merkleBuffer);
var base64data = Buffer.from(compressedData).toString('base64');
```
hashVaule的值，原始数据的hash值，生成代码如下：
```javascript
...
入参示例：
``` json
{"md5":"1b6f8482b81cd0bdd6ccadb97985a486","email":"tianbao.liu@megaops.net","orderId":"111222","filePath":"4.txt","fileSize":"4","cid":"QmWshQsfWR1Cih7kAqpS4AnCVyifNBnbPRPxTeyTc4GTyM","partArr":[{"partId":3,"base64data":"","hashVaule":"843cb536a5ce95d329a30fd1b297b7fb"}],"deviceType":3}
```
...
入参示例：
``` json
{"email":"tianbao.liu@megaops.net","orderId":"28","pageSize":4,"pageNo":1, "deviceType":3}
```
...
# 获取全量文件列表
http://127.0.0.1:3000/file/list_all<br>
接口类型：HTTP<br>
POST，content-type:json<br>
...
入参示例：
``` json
{"email":"tianbao.liu@megaops.net","orderId":"333", "deviceType":3}
```
        ...
        "data": [
            {
                ...
                "file_path": "test5.zip",
                "file_size": 50252686,
                "md5": "5c788ac8fcc5b56539015a9b374eb49e",
                "cid": "QmcsxBEbyn3qc4NkFSzx4y6b76iQNQEVdQcNRfmDwEckb4",
                "device_type": 3,
                "update_time": "2023-05-30 19:23:37",
                "create_time": "2023-05-30 19:23:37",
                "_id": "S07QqsvOZiOBy56p"
            },
            {
                "order_id": "333",
                "email": "tianbao.liu@megaops.net",
                "file_path": "6.txt",
                "file_size": 11,
                "md5": "272b0640e0f9e6b5a3a5e2f2c2b6af4d",
                "cid": "QmWHpAnUBYkHxKpwQKdP1A7Kefh3xGYe5zMcod8LBgPzcG",
                "device_type": 3,
                "update_time": "2023-05-30 19:01:23",
                "create_time": "2023-05-30 19:01:23",
                "_id": "Xq0OjNM9ksUEGUvt"
            },
            {
                "order_id": "333",
                "email": "tianbao.liu@megaops.net",
                "file_path": "4.txt",
                "file_size": 4,
                "md5": "1b6f8482b81cd0bdd6ccadb97985a486",
                "cid": "QmTkQHnygwEwhioCV7fP1FTNPG272hsps6XGeQ924F4oQ6",
                "device_type": 3,
                "update_time": "2023-05-30 18:49:58",
                "create_time": "2023-05-30 18:49:58",
                "_id": "YleLuEngkExy5N3s"
            },
            {
                "order_id": "333",
                "email": "tianbao.liu@megaops.net",
                "file_path": "test4.zip",
                "file_size": 17801378,
                "md5": "695b6b4441855dc6d1927a1c58ddc970",
                "cid": "QmbznWHDkCY9aSyzrYXW4qpeP7TUVqL66qFodaNQiW3B7G",
                "device_type": 3,
                "update_time": "2023-05-30 19:22:44",
                "create_time": "2023-05-30 19:22:44",
                "_id": "cURJbnakQJcf4oba"
            }
        ],
        "time": 1685504800669
    },
...
|foggieToken|string|否|foggie/foggie max的上传文件token|
|file|file|否|文件的二进制流|
...
# 校验能否上传文件
http://127.0.0.1:3000/file/upload_valid<br>
接口类型：HTTP<br>
POST，content-type:json<br>
入参：
|参数名|数据类型|是否可为空|备注|
...
|email|string|是|foggie邮箱，fileName有值的情况下，不能为空|

入参示例：
``` json
{"email":"tianbao.liu@megaops.net","orderId":"333", "deviceType":3, "fileName":"8.txt"}
```
...
入参示例：
``` json
{"email":"tianbao.liu@megaops.net","fileName":"Users/carl/Documents/foggie.pages","md5":"114cc4641fc49b909126973f6343c243","fileSize":95853,"fileType":"pages", "orderId":"231","foggieToken":"Qp89ua7fKLp1H1JjqEVIQ"}
```
...
入参示例：
``` json
{"fileName":"Users/carl/Documents/foggie.pages","parts":"[{\"partNumber\":123445,\"etag\":\"adw1231\"}]","uploadId":"f93346b6dd4a60a4fd30987e6266065e736124a0b9ec292a","orderId":"231","md5":"114cc4641fc49b909126973f6343c243","fileSize":95853,"deviceType":1, "email":"tianbao.liu@megaops.net","foggieToken":"Qp89ua7fKLp1H1JjqEVIQ"}
```
...
# 查询文件
http://127.0.0.1:3000/file/query<br>
接口类型：HTTP<br>
POST，content-type:json<br>
入参：
|参数名|数据类型|是否可为空|备注|
...
|orderId|string|否|订单id|
|deviceType|int|否|设备类型，1 foggie 2 foggie max 3 client|
|key|string|否|文件路径 或者 cid|

入参示例：
``` json
{"email":"tianbao.liu@megaops.net","orderId":"333", "deviceType":3, "key":"QmTkQHnygwEwhioCV7fP1FTNPG272hsps6XGeQ924F4oQ6"}
```
...
# 转账校验
http://127.0.0.1:3000/assets/transfer_valid<br>
接口类型：HTTP<br>
POST，content-type:json<br>
...
``` json
{
    ...
    "data": {
        ...
        "msg": "success",
        "data": {
            "imageUrl": "data:image/png;base64,",
            "secret": "OB5GGUB7PBQT4PSA",
            "account": "Foggie(tianbao.liu@megaops.net)"
        },
        "time": 1683539132176
    },
    "time": 1683539132176
...
```
返回值说明：data->data返回的数据，包含（imageUrl 二维码的图片，secret 校验码的secret，account 校验码的账户名），有值展示 二维码和校验码输入框 提交后需要 调用/assets/bind_valid 绑定校验码 ；没有值展示校验码输入框 提交调用 /assets/transfer 转账

# 绑定校验
http://127.0.0.1:3000/assets/bind_valid<br>
接口类型：HTTP<br>
POST，content-type:json<br>
...
|:---|:---|:---|:---|
|email|string|否|foggie邮箱地址|
|secret|string|否|google校验的secret|
|userToken|string|否|google校验的校验码|
...
入参示例：
``` json
{"chainId":"bb6e31180359e169335481bad672aadf57cfb5787379bedb6a5dce916fcb0ac5","email":"tianbao.liu@megaops.net", "userToken":"167929","to":"xuxindmc1234","memo":"test","amount":"1.1211"}
```
...
``` json
{
    ...
    "data": {
        ...
        "data": [
            ...
            {
                "order_num": 50,
                "total_space": 22548578304,
                "used_space": 204661051
            }
        ],
        "time": 1683879006175
    },
