...
入参示例：
``` json
{"username":"tbliuca12345","chainId":"bb6e31180359e169335481bad672aadf57cfb5787379bedb6a5dce916fcb0ac5","email":"tianbao.liu@megaops.net","billId":"11","period":24,"benchmarkPrice":"1.00000000000000000","unmatchedAmount":"1","totalPrice":"25.0000","priceRange":3}
```
返回数据：
...
入参示例：
``` json
{"chainId":"4d1fb981dd562d2827447dafa89645622bdcd4e29185d60eeb45539f25d2d85d","username":"tianbao12345","email":"tianbao.liu@megaops.net", "orderId":"231"}
```
...
入参示例：
``` json
{"orderId":"231","email":"tianbao.liu@megaops.net","username":"tianbao12345"}
```
返回数据示例：
``` json
{
...
入参示例：
``` json
{"chainId":"4d1fb981dd562d2827447dafa89645622bdcd4e29185d60eeb45539f25d2d85d","username":"tianbao12345","email":"tianbao.liu@megaops.net", "orderId":"231", "md5":"114cc4641fc49b909126973f6343c243"}
```
