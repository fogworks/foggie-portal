...
|参数名|数据类型|是否可为空|备注|
|-|:------|:-----|:-----|
|username|string|否|测试时可以为空，空则取默认的用户名tianbao12345|
...
入参示例：
``` json
{"unmatchedAmount":1,"period":24,"minPrice":0.0011,"maxPrice":0.0123,"username":"tianbao12345"}
```
返回数据示例：
``` json
{
...
入参示例：
``` json
{"username":"tianbao12345","chainId":"4d1fb981dd562d2827447dafa89645622bdcd4e29185d60eeb45539f25d2d85d","billId":"118","period":"24", "benchmarkPrice":"0.011","priceRange":1,"unmatchedAmount":"1","totalPrice":"0.2750"}
```
返回数据示例：
``` json
...
入参示例：
``` json
{"limit":10,"pageNum":1,"username":"tianbao12345"}
```
...
入参示例：
``` json
{"chainId":"4d1fb981dd562d2827447dafa89645622bdcd4e29185d60eeb45539f25d2d85d","username":"tianbao12345","password":"1958f26534b8542b0069ddbff369213d21fce522a25f86b7a1c31a5e920ad9fe", "orderId":"231"}
```
...
入参示例：
``` json
{"username":"tianbao12345","orderId":"158","pageSize":4,"pageNo":1}
```
...
入参示例：
``` json
{"pageNum":2,"limit":10,"orderId":156}
```
...
|:---|:---|:---|:---|
|orderId|int|否|订单id|
|email|string|否|foggie邮箱地址，用于获取私钥，避免接口请求过程中传输私钥|
|username|string|否|用户名|

入参示例：
``` json
{"orderId":"231","password":"58df9379402ab6c87a51be426290e0f752ba5be4fe45736674a05dc12e642c50","username":"tianbao12345"}
```
返回数据示例：
``` json
{
...
入参示例：
``` json
{"username":"tianbao12345","orderId":"123","filePath":"/opt/asd/vvff","fileSize":"1111"}
```
...
入参示例：
``` json
{"username":"tianbao12345","orderId":"123","pageSize":4,"pageNo":1}
```
...
"order_id": "123",
"username": "tianbao12345",
"file_path": "opt/asd/vvff",
"file_size": "1111",
"update_time": "2023-04-20 10:13:59",
"create_time": "2023-04-20 10:13:59",
"_id": "W7jSL8TTiL9il5Uf"
},
{
"order_id": "123",
"username": "tianbao12345",
"file_path": "opt/asd/vvv",
"update_time": "2023-04-20 10:13:07",
"create_time": "2023-04-19 23:20:59",
"_id": "V3ePe81tNo0YNZrl",
"file_size": "4365676"
},
{
"order_id": "123",
"username": "tianbao12345",
"file_path": "opt/asd/ddd",
"update_time": "2023-04-19 23:20:52",
"create_time": "2023-04-19 23:20:52",
"_id": "c9j6uHaoikgWi12a"
},
{
"order_id": "123",
"username": "tianbao12345",
"file_path": "opt/asd/ad",
"update_time": "2023-04-19 23:20:47",
"create_time": "2023-04-19 23:20:47",
"_id": "ml317IQDnMa8JCbW"
}
],
"count": 4
},
...
入参示例：
``` json
{"username":"tianbao12345","fileName":"Users/carl/Documents/foggie.pages","md5":"114cc4641fc49b909126973f6343c243","fileSize":95853,"fileType":"pages", "orderId":"231","token":"58df9379402ab6c87a51be426290e0f752ba5be4fe45736674a05dc12e642c50","peerId":"12D3KooWDj1NkJ1DrVvpbBhtJ3nLCNA9CKyg3eynpiUTKsVEDkgx"}
```
...
入参示例：
``` json
{"fileName":"Users/carl/Documents/foggie.pages","parts":"[{\"partNumber\":123445,\"etag\":\"adw1231\"}]","uploadId":"f93346b6dd4a60a4fd30987e6266065e736124a0b9ec292a","orderId":"231", "peerId":"12D3KooWDj1NkJ1DrVvpbBhtJ3nLCNA9CKyg3eynpiUTKsVEDkgx","token":"58df9379402ab6c87a51be426290e0f752ba5be4fe45736674a05dc12e642c50","peerId":"12D3KooWDj1NkJ1DrVvpbBhtJ3nLCNA9CKyg3eynpiUTKsVEDkgx","md5":"114cc4641fc49b909126973f6343c243","fileSize":95853,"username":"tianbao12345"}
```
...
入参示例：
``` json
{"chainId":"4d1fb981dd562d2827447dafa89645622bdcd4e29185d60eeb45539f25d2d85d","username":"tianbao12345","password":"1958f26534b8542b0069ddbff369213d21fce522a25f86b7a1c31a5e920ad9fe", "orderId":"231", "md5":"114cc4641fc49b909126973f6343c243"}
```
